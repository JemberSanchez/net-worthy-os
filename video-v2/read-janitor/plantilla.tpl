...
__FOTOS__
    ...
    <script>
      ...
      const kb = [
        ...
        ["#ph-cta-img", { scale: 1.3, x: -60, y: 0 }, { scale: 1.12, x: 60, y: 0 }],
      ];
      kb.forEach(([sel, a, b]) => {
      ...
      tl.to("#pl1, #pl2", { scale: 1.07, duration: 0.45, yoyo: true, repeat: 3, ease: "sine.inOut" }, we(161) + 0.2);
      tl.to("#cta-s", { y: 16, duration: 0.4, yoyo: true, repeat: 3, ease: "sine.inOut" }, we(161) + 0.4);
